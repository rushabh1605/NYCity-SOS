...
from hiren.app.config import GEMINI_API_KEY, MODEL_NAME, LIVE_API_URL
from hiren.app.system_prompt import SYSTEM_INSTRUCTION
from hiren.app.tool_handler import TRIGGER_ESCALATION_TOOL, alert_manager, create_alert_payload
    ...
    async def start(self):
        if not self.api_key:
            ...
            await self.client_ws.send_json({
                "type": "error",
                "message": "Missing GEMINI_API_KEY. Please set the environment variable."
            })
            return
